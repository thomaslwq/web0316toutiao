    ...
    <div class="body">
        ...
        <div class="main">
            ...
            <el-tab-pane label="账户信息" name="admin" class="admin">
                <div class="name">
                    <span>名称</span> <input type="text" v-model="username">
                </div>
                <div class="pic">
                    <span>头像</span>
            ...
            <el-tab-pane label="密码管理" name="pass" class="admin">
                <div class="oldp">
                    <span>旧密码</span><input type="password" v-model="oldpass">
                </div>
                <div class="newp">
                    <span>新密码</span><input type="password" v-model="newpass">
                </div>
                <div>
...
export default {
    ...
    methods: {
        ...
        updataUser(){
            if(this.username === this.userinfo.nickname && this.avator === this.userinfo.avator)return;
        ...
        updataPass(){
            if(!this.newpass || !this.oldpass)return;
                let param = new FormData();
				param.append('currenPassword',this.oldpass);
